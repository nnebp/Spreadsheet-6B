...
/**
 * Holds and evaluates expression tree from a string
 * formula. 
 * 
 * @author nepb
...
public class Evaluator {
	 ...
	 /** String representing a cell formula */
	 private String myFormula;
	 
	 /** Reference to cell array */
	 private Cell[][] myCells;
	
	/**
	 * Default constructor.
	 * 
	 * @param formula formula for this cell
	 * @param cells 2-d array of cell objects
	 */
	 ...
	 /**
	  * Sets the value of formula equal to the input.
	  * 
	 ...
	 /**
	  * Sets the reference to the 2-d array of cells equal to 
	  * to the input.
	  * 
	  * @param theCells 2-d array of cells
	  */
	 public void setReference(Cell[][] theCells) {
		 myCells = theCells;
	 }
